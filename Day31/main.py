...
try:
    ...
    original_data = pandas.read_csv("Day31/data/swedish_word_list.csv")
...
card_title = canvas.create_text(400, 150, text="", font=("Comic Sans MS", 40, "italic"))
card_word = canvas.create_text(400, 263, text="", font=("Comic Sans MS", 60, "bold"))
